...
const ByteStreamInterface cFileByteStreamInterface = { fileByteReadStreamRead, NULL, NULL };
...
{
	in_pFileByteStreamState->mByteStreamInterface = cFileByteStreamInterface;
