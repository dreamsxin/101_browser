...
Windows Vista/Server 2008/7 (currently only tested under Windows 7, but the other ones should work). At the moment it should still work under 
Windows XP, but it is highly probably that in near future it won't run these anymore because of using APIs that were introduced with Vista that 
simply the code.
